    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('number', models.IntegerField(db_index=True, max_length=255, unique=True, verbose_name='Номер ящика')),
                ...
                ('date_off', models.DateTimeField(verbose_name='Оставшееся время')),
